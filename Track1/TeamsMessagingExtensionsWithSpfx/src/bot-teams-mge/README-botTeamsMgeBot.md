# bot teams mge Bot - `botTeamsMgeBot`
...
3. Give the bot a handle (ex: `botTeamsMgeBot`), choose your subscription and resource group
4. For the messaging endpoint, use this: `https://botteamsmge.azurewebsites.net/api/messages`
